...
&lt;html&gt;
    &lt;head&gt;
      ...
      a div span { border: 1px solid black;visibility:hidden;padding: 3px 3px 3px 3px;text-align:center;background-color:white;color:black;position:absolute;z-index:1;display: inline-block;overflow:none;width:auto;white-space:nowrap;float:left;}
